      ...
      <section className="travel">
        ...
        <section className="story">
          ...
          <p className="paragraph-story">
            ...
            <span> HTML</span> and <span>CSS</span>, I'm going to share with you my last project 
            <span><strong><a href="https://hovify.works/"> HoviFy</a></strong></span>, in this project my role was as a Frontend developer with
            <span> React</span>.
          </p>
          <div className="image-story">
            <Fade right>
